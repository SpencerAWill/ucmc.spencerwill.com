...
- `.devcontainer/` — Dev container configuration (`initialize.sh` on the host, `configure-git.sh` on create; see CLAUDE.md on git index-lock contention on the virtiofs bind mount)

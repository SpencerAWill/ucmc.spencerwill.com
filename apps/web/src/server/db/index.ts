...
// file ends up in the client bundle (TanStack Start's RPC compiler doesn't
// strip transitive server-module imports), and the client-side stub for
// `cloudflare:workers` throws if accessed.

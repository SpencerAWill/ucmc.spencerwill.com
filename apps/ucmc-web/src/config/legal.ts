...
export const PRIVACY_BODY: readonly LegalSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "You can delete your account immediately at any time via the controls on /my/preferences; this also removes your avatar from R2 and signs you out everywhere.",
    ],
  },
  {
    heading: "Your rights",
    paragraphs: [
      "You can download a JSON copy of everything we have on you from /my/preferences. You can hard-delete your account from the same page; the deletion is immediate and irreversible. To correct or update individual fields, edit them on /my/profile (public profile), /my/details (private details), or /my/contacts (emergency contacts). To add, remove, or change the primary address for your sign-in emails, use /my/details.",
    ],
  },
  {
    heading: "Cookies",
...
export const TERMS_BODY: readonly LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "You can delete your account at any time from /my/preferences; deletion is immediate and irreversible. UCMC officers may deactivate accounts that violate these terms or club policies; deactivated accounts can be reactivated by an officer.",
    ],
  },
  {
